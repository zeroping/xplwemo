...
public:
    ...
    GPIOPin( const string gnum ); // create a GPIO object that controls GPIOx, where x is passed to this constructor
    int export_gpio(); // exports GPIO
    int unexport_gpio(); // unexport GPIO
    int setdir_gpio( const string dir ); // Set GPIO Direction
