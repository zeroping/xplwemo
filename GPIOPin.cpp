...
GPIOPin::GPIOPin(const string gnum)
{
    this->gpionum = gnum;  //Instatiate GPIOPin object for GPIO pin number "gnum". It's a string to handle the odd names that might be used.
}
...
int GPIOPin::setdir_gpio(const string dir)
{
...
int GPIOPin::setval_gpio(const string val)
{
